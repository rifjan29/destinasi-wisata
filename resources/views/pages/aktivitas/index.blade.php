    ...
    <div class="row height align-items-center justify-content-center">
        <div class="col-lg-10">
            <div class="generic-banner-content">
                <h2 class="text-white">{{ __('general.menu.activity') }}</h2>
                <nav aria-label="breadcrumb" class="d-flex justify-content-center">
                    <ol class="breadcrumb " style="background-color: #83c5bf7c;">
                      ...
                      <li class="breadcrumb-item active" style=" color: #000" aria-current="page">{{ __('general.menu.activity') }}</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            @forelse ($data as $item)
                <div class="row d-flex mb-4">
                    <div class="col-md-4 align-self-center d-flex justify-content-center">
                        <img src="{{ asset('img/aktivitas/'.$item->photos) }}" class="img-responsive" width="300" height="300" alt="">
                    </div>
                    <div class="col-md-8">
                        <div class="">
