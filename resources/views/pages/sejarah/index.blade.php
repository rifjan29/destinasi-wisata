    ...
    <div class="row height align-items-center justify-content-center">
        <div class="col-lg-10">
            <div class="generic-banner-content">
                <h2 class="text-white">{{ __('general.menu.history') }}</h2>
                <nav aria-label="breadcrumb" class="d-flex justify-content-center">
                    <ol class="breadcrumb " style="background-color: #83c5bf7c;">
                      ...
                      <li class="breadcrumb-item active" style=" color: #000" aria-current="page">{{ __('general.menu.history') }}</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container border-top-generic">
            <div class="row d-flex">
                ...
                <div class="col-md-4 align-self-center d-flex justify-content-center">
                    <img src="{{ asset('img/sejarah/'.$data->photos) }}" class="img-responsive" width="300" height="300" alt="">
                </div>
            </div>
        </div>
    </section>
