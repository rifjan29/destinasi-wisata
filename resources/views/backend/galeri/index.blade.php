                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                ...
                                <div>
                                    <a href="{{ route('galeri.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Data</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        @forelse ($data as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ asset('img/galeri/'.$item->photos) }}" alt="" class="w-50 img-fluid">
                                                </td>
                                                <td>{{ ucwords( $item->title ) }}</td>
                                                <td>{{ $item->status == 'en' ? 'Inggris' : 'Indonesia' }}</td>
                                                <td>
                                                    <div class="table-data-feature d-flex justify-content-start">
                                                        <a href="{{ route('galeri.edit',$item->id) }}" class="item" data-toggle="tooltip" data-placement="top" title="Edit">
