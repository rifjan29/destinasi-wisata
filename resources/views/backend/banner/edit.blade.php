                                ...
                                <form action="{{ route('banner.update',$data->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="text" name="judul" value="{{ old('judul',$data->title) }}" class="form-control @error('judul') is-invalid @enderror" id="validationServer03" placeholder="Masukkan Judul">
                                            @error('judul')
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea name="subtitle" class="form-control @error('subtitle') is-invalid @enderror" placeholder="Masukkan Subtitle"  id="" cols="30" rows="10">{{ old('subtitle',$data->subtitle) }}</textarea>
                                            @error('subtitle')
                                                <div class="invalid-feedback">
                                                    {{ $message }}.
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="photos-preview h-100 rounded" style="background-color: #e5e5e5">
                                                        <div class=" ">
                                                            <img src="{{ asset('img/banner/'.$data->banner) }}" class="img-fluid rounded d-flex align-items-center " id="photosPreview" alt="Foto Banner">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-8">
