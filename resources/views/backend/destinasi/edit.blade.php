            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="p-4">
                                <form action="{{ route('destinasi.update',$data->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-row form-group">
                                        <div class="col-md-12 mb-3 ">
                                            <label for="">Judul</label>
                                            <input type="text" name="judul" class="form-control @error('judul') is-invalid @enderror" value="{{ old('judul',$data->title) }}" id="validationServer03" placeholder="Masukkan Judul">
                                            @error('judul')
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="id_provinsi" id="provinsi" class="select2 form-control">
                                                ...
                                                <option value="{{ $item->province_id }}" {{ $item->province_id == $data->province_id ? 'selected' : '' }}> {{ ucwords( $item->province ) }}</option>
                                                @endforeach
                                            </select>
                                            @error('id_provinsi')
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" id="" cols="30" rows="10">{{ old('alamat',$data->alamat) }}</textarea>
                                            @error('alamat')
                                                <div class="invalid-feedback">
                                                    {{ $message }}.
                                                </div>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            @enderror">
                                                ...
                                                @foreach ($data_kategori as $item)
                                                    <option value="{{ $item->id }}" {{ $item->id == $data->kategori_destinasi_id ? 'selected' : ''}}>{{ ucwords( $item->name ) }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-12 mb-3 ">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input @error('lang') is-invalid @enderror" type="radio" name="lang" id="exampleRadios2" value="en" {{ old('lang',$data->status == 'end' ? 'checked' : '') }}>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="photos-preview h-100 rounded" style="background-color: #e5e5e5">
                                                        <div class=" ">
                                                            <img src="{{ asset('img/destinasi/'.$data->photos) }}" class="img-fluid rounded d-flex align-items-center " id="photosPreview" alt="Foto Pengguna">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-8">
