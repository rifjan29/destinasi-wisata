                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                ...
                                <div>
                                    <a href="{{ route('fasilitas.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Data</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        @forelse ($data as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ asset('img/fasilitas/'.$item->photos) }}" alt="" class="w-50 img-fluid">
                                                </td>
                                                ...
                                                <td>
                                                    <div class="table-data-feature d-flex justify-content-start">
                                                        <a href="{{ route('fasilitas.edit',$item->id) }}" class="item" data-toggle="tooltip" data-placement="top" title="Edit">
