                                ...
                                <form action="{{ route('fasilitas.update',$data->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row form-group">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea id="summernote" name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" cols="30" rows="10">{{ $data->deskripsi }}</textarea>
                                            @error('deskripsi')
                                                <div class="invalid-feedback">
                                                    {{ $message }}.
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="photos-preview h-100 rounded" style="background-color: #e5e5e5">
                                                        <div class=" ">
                                                            <img src="{{ asset('img/fasilitas/'.$data->photos) }}" class="img-fluid rounded d-flex align-items-center " id="photosPreview" alt="Foto Aktivitas">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-8">
